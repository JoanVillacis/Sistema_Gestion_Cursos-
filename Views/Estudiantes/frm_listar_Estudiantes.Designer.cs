namespace Gestion_Cursos.Views.Estudiantes
{
    partial class frm_listar_Estudiantes
    {
        ...
        private void InitializeComponent()
        {
            ...
            lst_lista_estudiantes.Location = new Point(136, 43);
            lst_lista_estudiantes.Name = "lst_lista_estudiantes";
            lst_lista_estudiantes.Size = new Size(731, 283);
            lst_lista_estudiantes.TabIndex = 33;
            ...
            btn_salir.Location = new Point(11, 259);
            ...
            btn_eliminar.Location = new Point(11, 200);
            ...
            btn_editar.Location = new Point(11, 136);
            ...
            label1.TabIndex = 32;
            label1.Text = "CENTRO DE CONTROL DE ESTUDIANTES";
            // 
            // btn_agregar
            // 
            btn_agregar.BackColor = Color.FromArgb(0, 119, 182);
            btn_agregar.ForeColor = Color.White;
            btn_agregar.Location = new Point(11, 67);
            ...
            MaximizeBox = false;
            Name = "frm_listar_Estudiantes";
            ShowIcon = false;
            Text = "Listar Estudiantes";
            Load += frm_listar_Estudiantes_Load;
            ResumeLayout(false);
            PerformLayout();
        }
