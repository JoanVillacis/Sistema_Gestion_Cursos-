...
{
    public partial class frm_agregar_Profesor : Form
    {
        ...
        private void frm_agregar_Profesor_Load(object sender, EventArgs e)
        {
            //no se usa
        }
        ...
        private void txt_Correo_Leave(object sender, EventArgs e)
        {
            ...
            // Verificar duplicado
            if (_profesorController.EmailExists(txt_Correo.Text.Trim()))
            {
        ...
        private void txt_Cedula_Leave(object sender, EventArgs e)
        {
            ...
            // Verificar algoritmo con Auth_Controller
            ...
            // Verificar duplicado
            if (_profesorController.CedulaExists(ced))
            {
        ...
        private void btn_Guardar_Click(object sender, EventArgs e)
        {
            ...
            var res = _profesorController.insertar(profesor);
            if (res == "ok")
            {
                MessageBox.Show("Profesor guardado correctamente.", "Información", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void btn_Cancelar_Click(object sender, EventArgs e)
        {
            ...
            if (cmb_Genero.Items.Count > 0)
            {
                ...
                cmb_Genero.Text = string.Empty;
            }
            if (cmb_Especialidad.Items.Count > 0)
            {
