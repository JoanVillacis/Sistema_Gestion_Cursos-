...
namespace Gestion_Cursos.Views.Cursos
{
    public partial class frm_editar_Curso : Form
    {
        ...
        private int _id;
        private string _originalNombreCurso = string.Empty;
        ...
        public void CargarCurso()
        {
            ...
            // guardar nombre original para evitar falso positivo en validación
            _originalNombreCurso = curso.NombreCurso ?? string.Empty;
        }
        ...
        private void txt_Nombres_Leave(object sender, EventArgs e)
        {
            ...
            var nombreActual = txt_Nombres.Text.Trim();
            // si el nombre no cambió respecto al original no validar como duplicado
            if (string.Equals(_originalNombreCurso, nombreActual, StringComparison.OrdinalIgnoreCase)) return;

            if (_cursoController.NombreExists(nombreActual))
            {
