...
{
    public partial class frm_agregar_Incripcion : Form
    {
        ...
        private void frm_agregar_Estudiante_Load(object sender, EventArgs e)
        {
            // Se mantiene vacío; CargarListas se llama en el constructor
        }
        ...
        private void btn_Guardar_Click(object sender, EventArgs e)
        {
            ...
            if (_inscripcionController.ExisteInscripcion(estudianteId, cursoId))
            {
                MessageBox.Show("El estudiante ya está inscrito en ese curso.", "Duplicado", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            ...
            var res = _inscripcionController.insertar(ins);
            if (res == "ok")
            {
                MessageBox.Show("Inscripción guardada correctamente.", "Información", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void btn_Cancelar_Click(object sender, EventArgs e)
        {
            ...
            txt_Estudiante.Text = string.Empty;
